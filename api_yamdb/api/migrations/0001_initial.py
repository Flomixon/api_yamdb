    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='score', to='api.Title')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='genretitle',
            constraint=models.UniqueConstraint(fields=('genre', 'titlegit'), name='unique_genr_title'),
        ),
        migrations.AddConstraint(
